...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    createUser(registerData.email, registerData.password)
      ...
      .then(() => {
        toast.success("Successfully Registration in Website", {
          autoClose: 3000,
        });
        setLoading(false);
      })
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
          <div className="text-center">
            <Link to="/">
              <h2 className="inline-block text-3xl font-bold mb-2">
                <Logo></Logo>
              </h2>
            </Link>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  placeholder-gray-500 text-gray-900 rounded-lg
                   focus:outline-none focus:ring-2 focus:ring-blue-500
                    focus:border-blue-500 focus:z-10 transition-colors"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:z-10 transition-colors pr-12"
                    placeholder="Enter your password"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword((s) => !s)}
                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5 text-gray-500 hover:text-gray-700 transition-colors"
                  >
                    {showPassword ? (
                      <FaEyeSlash size={18} />
                    ) : (
                ...
                <div className="mt-3 space-y-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <PasswordRequirement
                    ...
                    text="Minimum 6 characters length"
                  />
                </div>
              </div>
            </div>
            ...
            <div>
              <button
                type="submit"
                className=" relative w-full flex justify-center py-3 px-4 border-none text-lg font-medium rounded-lg bg-green-500 text-white hover:bg-gradient-to-br from-[#632ee3] to-[#9f62f2]"
